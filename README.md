...
# MSX0 REMOTE UPLOADER version 0.1.9
...
![image](https://github.com/enu7/msx0reup/blob/main/icon/convert_CRLF_btn.png) 該当ファイルの改行コードをCR+LFに置換するボタン
## 転送機能エリア
![image](https://github.com/enu7/msx0reup/blob/main/icon/upload_file_btn.png) 選択した一時領域のファイルをMSX0にアップロードするボタン
![image](https://github.com/enu7/msx0reup/blob/main/icon/download_msx0file_btn.png) 選択したMSX0上のファイルを一時領域にダウンロードするボタン
注意：転送速度は遅いです
## MSX0一覧エリア
